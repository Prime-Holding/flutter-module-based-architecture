...
```
    ...
    <array>
        ...
        <string>melostest.example.com</string>
...
Production
```
xcrun simctl openurl booted examplescheme://melostest.example.com/deepLinks/1
```

UAT
```
xcrun simctl openurl booted exampleuatscheme://melostestuat.example.com/deepLinks/1
```

SIT
```
xcrun simctl openurl booted examplesitscheme://melostestsit.example.com/deepLinks/1
```

Development
```
xcrun simctl openurl booted exampledevscheme://melostestdevelopment.example.com/deepLinks/1
```
