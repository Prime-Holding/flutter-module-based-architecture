...
class EnterMessagePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: customAppBar(context, title: context.l10n.pageWithResult),
    body: Column(
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: context.designSystem.colors.black),
              borderRadius: BorderRadius.all(
                Radius.circular(context.designSystem.spacing.xs),
              ),
            ),
            child: Text(
                ...
                RxBlocBuilder<EnterMessageBlocType, String?>(
                  ...
                  builder: (context, message, bloc) => Padding(
                    ...
                    child: TextFieldDialog<String>(
                      ...
                      label: context.l10n.fieldMessageLabel,
                      value: message.data,
                      emptyLabel: context.l10n.fieldHintMessage,
                      validator: context.read<EnterMessageFieldService>(),
                      header: context.l10n.fieldHintMessage,
                      onChanged: (value) => bloc.events.setMessage(value),
                      modalConfiguration: const TextFieldModalConfiguration(
                        safeAreaBottom: false,
                      ),
                      fillButtonText: context.l10n.fillButtonText,
                    ),
                  ),
                ),
