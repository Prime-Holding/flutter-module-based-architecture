...
class LoginForm extends StatefulWidget {
  const LoginForm({this.title = 'Enter your login credentials', super.key});
...
class _LoginFormState extends State<LoginForm> {
  ...
  List<FocusNode> get _focusNodes => [_emailFocusNode, _passwordFocusNode];
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      RxTextFormFieldBuilder<LoginBlocType>(
        ...
        builder: (fieldState) => _buildEmailField(fieldState, context),
      ),
      ...
      RxTextFormFieldBuilder<LoginBlocType>(
        ...
        obscureText: true,
        builder: (fieldState) => _buildPasswordField(fieldState, context),
      ),
      SizedBox(height: context.designSystem.spacing.xs1),
  ...
  TextFormField _buildEmailField(
    ...
    decoration: fieldState.decoration.copyWith(labelText: context.l10n.email),
  );
